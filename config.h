...
#if defined(LCD_USE_SSD1306_OLED_MODULE) + defined(LCD_USE_1602_LCD_MODULE) + defined(LCD_USE_SSD131X_OLED_MODULE) +defined(LCD_USE_MCUFRIEND_TFT_MODULE) != 1
...
#define TAPE_READ_PORT      PORTA
#define TAPE_READ_DDR       DDRA
#define TAPE_READ_PIN       2
#define TAPE_READ_PINS      PINA
#define TAPE_READ_LOW()     TAPE_READ_PORT &= ~_BV(TAPE_READ_PIN)
#define TAPE_READ_HIGH()    TAPE_READ_PORT |=  _BV(TAPE_READ_PIN)

#define TAPE_WRITE_PORT     PORTA
#define TAPE_WRITE_DDR      DDRA
#define TAPE_WRITE_PINS     PINA
#define TAPE_WRITE_PIN      4

#define MOTOR_PORT          PORTA
#define MOTOR_DDR           DDRA
#define MOTOR_PIN           0
#define MOTOR_PINS          PINA
...
#define TAPE_WRITE_PORT     PORTC
#define TAPE_WRITE_DDR      DDRC
#define TAPE_WRITE_PINS     PINC
#define TAPE_WRITE_PIN      0

#define MOTOR_PORT          PORTG
#define MOTOR_DDR           DDRG
#define MOTOR_PIN           0
#define MOTOR_PINS          PING
#define MOTOR_IS_OFF()      (MOTOR_PINS & _BV(MOTOR_PIN))
